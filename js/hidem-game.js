...
playerLeft.src = 'assets/imgs/fish_swim_left.png';

const playerRight = new Image();
playerRight.src = 'assets/imgs/fish_swim_right.png';
...
bubbleImage.src = 'assets/imgs/bubble_pop_frame_01.png';
...
bubblePop1.src = 'assets/sound/Plop.ogg';

const bubblePop2 = document.createElement('audio');
bubblePop2.src = 'assets/sound/bubbles-single2.wav';
...
background.src = 'assets/imgs/background1.png';
...
enemyImage.src = 'assets/imgs/enemy1.png';
...
class Enemy {
    ...
    draw(){
        ...
        ctx.fill();
        ctx.closePath();*/
        ctx.drawImage(enemyImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x - 50, this.y - 70, this.spriteHeight/3, this.spriteHeight/3);
    }
